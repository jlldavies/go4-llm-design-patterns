...
## Description
Promote R7 Reflexion's ephemeral, within-task verbal critiques into a durable lesson library that survives session resets, is injected into future contexts as light-weight guidance, and accumulates compounding improvement over time — giving the agent the closest thing to *learning* available without fine-tuning. Composes with R7, K12, V1, H4, H9. This is a condensed digest; the canonical file (`patterns/H2-Episodic-Self-Improvement.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[R7-Reflexion]] · [[K12-Karpathy-Memory]] · [[V1-Human-in-the-Loop]] · [[H4-Procedural-Skill-Accumulation]] · [[H9-Observational-Identity]] · [[H1-Identity-Persistence]] · [[K10-Long-Term-Memory]] · [[S8-Meta-Prompt]]
