...
## Description
Let the agent use the existing CLI ecosystem as its tool surface — invoking `git`, `docker`, `gh`, `kubectl`, cloud CLIs, and Unix utilities directly — so the integration carries zero schema-token overhead and inherits decades of battle-tested behaviour. Composes with V6, V11, V1. Sibling of I2, I3. This is a condensed digest; the canonical file (`patterns/I4-CLI-Invocation.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[V6-Prompt-Injection-Shield]] · [[V11-Error-Compaction]] · [[V1-Human-in-the-Loop]] · [[I2-Function-Call]] · [[I3-MCP-Server]] · [[I1-Direct-API]] · [[V8-Tool-Sandboxing]]
