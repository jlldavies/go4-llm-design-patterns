...
## Description
Improve reasoning on specific, detail-heavy questions by first answering a strictly more abstract version of them — extracting the underlying principle, concept, or class of fact — and then applying that principle back to the specific case. Composes with K5. This is a condensed digest; the canonical file (`patterns/R19-Step-Back-Prompting.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[K5-Adaptive-RAG]] · [[K2-Query-Transformation]] · [[R1-Zero-Shot-CoT]] · [[R3-Plan-and-Solve]]
