...
## Description
Answer queries that vary in scope — from a precise fact to a broad theme — by indexing the corpus as a multi-level summary tree and retrieving from the level of abstraction the query requires. Sibling of K3. This is a condensed digest; the canonical file (`patterns/K4-RAPTOR.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[K3-GraphRAG]] · [[K1-Vanilla-RAG]] · [[K6-Context-Compression]]
