...
## Description
Coordinate a fleet of specialised agents without a central orchestrator, by giving each agent the authority to hand control to any peer it deems better suited to the current step. Composes with O15. This is a condensed digest; the canonical file (`patterns/O10-Swarm.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[O15-Agent-Handoff]] · [[O7-Supervisor-Hierarchy]] · [[O6-Orchestrator-Workers]] · [[O11-Blackboard]] · [[O3-Routing]]
