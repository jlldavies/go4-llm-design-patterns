...
## Description
Give an agent a memory the LLM itself maintains as structured, dense, token-efficient notes — paying more at *write* time so every *read* is cheap, navigable, and useful. This is a condensed digest; the canonical file (`patterns/K12-Karpathy-Memory.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[K10-Long-Term-Memory]] · [[K11-Observational-Memory]] · [[K6-Context-Compression]]
