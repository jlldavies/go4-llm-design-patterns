...
composes_with: [O17, O2, V9, V14, V15]
...
## Description
When sub-tasks of a request are genuinely independent of each other, run them simultaneously across distinct LLM calls and aggregate the results programmatically, so wall-clock latency collapses from the sum of the calls to the maximum. Composes with O17, O2, V9, V14, V15. Sibling of R12. This is a condensed digest; the canonical file (`patterns/O4-Parallelization.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[O17-Agent-Isolation]] · [[O2-Prompt-Chaining]] · [[V9-Bounded-Execution]] · [[V14-Trajectory-Logging]] · [[V15-LLM-as-Judge]] · [[R12-Skeleton-of-Thought]] · [[O6-Orchestrator-Workers]] · [[O11-Blackboard]] · [[O12-Debate-Deliberation]] · [[R17-Self-Consistency-Voting]]
