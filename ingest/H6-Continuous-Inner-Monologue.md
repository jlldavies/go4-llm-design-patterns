...
## Description
Maintain a continuous, autonomous inner monologue — a Thinker process separate from the user-facing Responder — that reflects between turns, consolidates across sessions, and writes its conclusions to a shared memory the Responder reads on the next interaction. Composes with H1, R7. Sibling of H3. This is a condensed digest; the canonical file (`patterns/H6-Continuous-Inner-Monologue.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[H1-Identity-Persistence]] · [[R7-Reflexion]] · [[H3-Entropy-Driven-Curiosity]] · [[R16-Talker-Reasoner]] · [[H2-Episodic-Self-Improvement]] · [[H4-Procedural-Skill-Accumulation]] · [[H9-Observational-Identity]] · [[H5-Constitutional-Self-Alignment]]
