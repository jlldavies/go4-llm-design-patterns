...
## Description
Maintain a continuous, autonomous inner monologue — a Thinker process separate from the user-facing Responder — that reflects between turns, consolidates across sessions, and writes its conclusions to a shared memory the Responder reads on the next interaction. This is a condensed digest; the canonical file (`patterns/H6-Continuous-Inner-Monologue.md`) carries the full decision criteria, failure modes, and implementation.
