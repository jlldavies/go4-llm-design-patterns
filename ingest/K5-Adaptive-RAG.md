...
## Description
Make retrieval conditional and self-correcting, so the system retrieves only when retrieval helps and recovers when retrieval fails, instead of retrieving blindly on every query and trusting whatever returns. Composes with K2, V9. This is a condensed digest; the canonical file (`patterns/K5-Adaptive-RAG.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[K2-Query-Transformation]] · [[V9-Bounded-Execution]] · [[K1-Vanilla-RAG]] · [[K4-RAPTOR]] · [[V15-LLM-as-Judge]]
