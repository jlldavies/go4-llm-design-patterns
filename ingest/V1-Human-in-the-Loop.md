...
## Description
Make the agent halt at the boundary of any action whose cost-of-error exceeds the cost-of-delay, surface the planned action to a human in interpretable form, and resume only on an explicit verdict — so that irreversible, novel, or high-blast-radius actions never execute autonomously. Requires V10. In tension with V2. Composes with V14, V7. This is a condensed digest; the canonical file (`patterns/V1-Human-in-the-Loop.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[V10-Checkpointing]] · [[V2-Human-on-the-Loop]] · [[V14-Trajectory-Logging]] · [[V7-AgentSpec]] · [[H6-Continuous-Inner-Monologue]]
