...
## Description
Close the style gap between agent and user: infer how this user prefers to be communicated with — from explicit corrections, implicit engagement signals, and their own register — and apply those parameters at generation time, while explicitly preserving the identity invariants H1 holds constant. This is a condensed digest; the canonical file (`patterns/H7-Adaptive-Persona.md`) carries the full decision criteria, failure modes, and implementation.
