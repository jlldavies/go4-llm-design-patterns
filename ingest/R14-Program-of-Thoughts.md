...
## Description
For tasks whose hard part is computation — arithmetic, algebra, financial sums, statistical operations, symbolic manipulation — let the model write a short program and let a Python (or equivalent) interpreter compute the answer, instead of asking the model to compute in natural-language tokens. This is a condensed digest; the canonical file (`patterns/R14-Program-of-Thoughts.md`) carries the full decision criteria, failure modes, and implementation.
