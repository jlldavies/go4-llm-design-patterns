...
## Description
Improve the quality of an output by having the same model that produced it write a critique of it and revise from that critique, iterating until a stopping condition — without any external evaluator, ground-truth signal, or second model. This is a condensed digest; the canonical file (`patterns/R8-Self-Refine.md`) carries the full decision criteria, failure modes, and implementation.
