...
## Description
Keep a long-running task within the context window by summarising older or bulky content into a denser form, preserving as much of its information as the reclaimed space allows. This is a condensed digest; the canonical file (`patterns/K6-Context-Compression.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[K7-Context-Pruning]] · [[K4-RAPTOR]] · [[K10-Long-Term-Memory]] · [[K11-Observational-Memory]] · [[K12-Karpathy-Memory]]
