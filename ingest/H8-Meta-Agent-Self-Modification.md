...
## Description
Make the operational configuration of a production agent a continuously-improving artefact — tuned online against measured performance — while preventing the runaway, the reward-hack, and the unreviewed value-edit that unconstrained self-modification produces. This is a condensed digest; the canonical file (`patterns/H8-Meta-Agent-Self-Modification.md`) carries the full decision criteria, failure modes, and implementation.
