...
## Description
Replace re-deriving a reasoning structure on every hard problem with retrieving and instantiating a previously distilled *thought-template*, so the cost of search is paid once across a problem family rather than every problem in it. Composes with K1, K10. Sibling of R9, R10. This is a condensed digest; the canonical file (`patterns/R11-Buffer-of-Thoughts.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[K1-Vanilla-RAG]] · [[K10-Long-Term-Memory]] · [[R9-Tree-of-Thoughts]] · [[R10-LATS]] · [[K12-Karpathy-Memory]] · [[R2-Few-Shot-CoT]]
