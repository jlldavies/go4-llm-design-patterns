...
related: [O2, R4, R7, O5, O6]
composes_with: [O9, V15]
...
## Description
Improve a single carried state across rounds by running the same sequence of distinct agents — each with its own role, prompt, and output contract — on the state, until a termination judge says the state is good enough or a hard bound trips. Composes with O9, V15. This is a condensed digest; the canonical file (`patterns/O8-Loop-Agent.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[O9-Multi-Agent-Reflection]] · [[V15-LLM-as-Judge]] · [[O2-Prompt-Chaining]] · [[R4-ReAct]] · [[R7-Reflexion]] · [[O5-Evaluator-Optimizer]] · [[O6-Orchestrator-Workers]]
