...
## Description
Turn "is this output any good?" into a deterministic, schema-checkable call against a written rubric, so generative quality can be measured automatically — at scale, without human labels, and on dimensions traditional metrics cannot reach. This is a condensed digest; the canonical file (`patterns/V15-LLM-as-Judge.md`) carries the full decision criteria, failure modes, and implementation.
