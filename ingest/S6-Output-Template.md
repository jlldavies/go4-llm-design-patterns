...
## Description
Replace open-ended generation of "content plus format" with the simpler task of filling content into a predefined skeleton, so downstream parsers, chained LLM calls, and human reviewers see a consistent shape every run. Composes with S4. This is a condensed digest; the canonical file (`patterns/S6-Output-Template.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[S4-Instruction-Decomposition]]
