...
## Description
Cut end-to-end latency on long-form, structurally separable answers by writing the outline once and expanding every point in parallel, instead of decoding the whole answer token-by-token in a single sequential stream. This is a condensed digest; the canonical file (`patterns/R12-Skeleton-of-Thought.md`) carries the full decision criteria, failure modes, and implementation.
