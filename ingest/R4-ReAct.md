...
siblings: [R5, R13]
related: [V9, R3, R1, R2]
composes_with: [V14, O6, K8, K6, K7, R7]
conflicts_with: [R5]
...
## Description
Let an agent make its next decision *after* seeing the result of its last action, by interleaving short reasoning traces with tool calls and feeding each tool's return back into the model — so the trajectory adapts to what the environment actually says, instead of executing a plan written before any of it was known. In tension with R5. Composes with V14, O6, K8, K6, K7, R7. Sibling of R5, R13. This is a condensed digest; the canonical file (`patterns/R4-ReAct.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[R5-ReWOO]] · [[V14-Trajectory-Logging]] · [[O6-Orchestrator-Workers]] · [[K8-Working-Memory]] · [[K6-Context-Compression]] · [[K7-Context-Pruning]] · [[R7-Reflexion]] · [[R13-CodeAct]] · [[V9-Bounded-Execution]] · [[R3-Plan-and-Solve]] · [[R1-Zero-Shot-CoT]] · [[R2-Few-Shot-CoT]]
