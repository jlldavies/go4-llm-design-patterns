...
## Description
Close the *compositionality gap* — the failure mode in which a model can answer each sub-fact of a multi-hop question individually but cannot combine them — by forcing the model to ask and answer its own follow-up questions before composing the final answer. Composes with K1, R4. This is a condensed digest; the canonical file (`patterns/R6-Self-Ask.md`) carries the full decision criteria, failure modes, and implementation.
...
Related: [[K1-Vanilla-RAG]] · [[R4-ReAct]] · [[R3-Plan-and-Solve]] · [[R5-ReWOO]]
